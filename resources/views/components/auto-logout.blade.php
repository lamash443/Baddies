{{--
    ...
    After 9 min of inactivity → shows a 60-second warning modal.
    After 10 min of total inactivity → posts to /logout automatically.
    ⚠️ TESTING MODE — change back to 29/30 min for production.
...
<div id="al-overlay" role="dialog" aria-modal="true" aria-labelledby="al-title">
  <div id="al-card">
    ...
    <div id="al-header">
      <div id="al-logo-wrap">
        @if($alLogoExists)
          <img src="{{ asset('storage/' . $alLogo) }}" alt="Baddies Club Logo">
        @else
    ...
    <div id="al-body">
      ...
      {{-- Countdown ring (r=35 → circumference ≈ 219.9) --}}
...
<form id="al-logout-form" action="{{ route('logout') }}" method="POST" style="display:none;">
  @csrf
</form>
