    ...
    <div class="container text-center">
      ...
      <nav aria-label="breadcrumb" class="d-flex justify-content-center mt-3">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item active text-secondary" aria-current="page">{{ __('Prime Checkout') }}</li>
        </ol>
      </nav>
    </div>
  </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-12 col-lg-5 col-xl-4">
        <div class="dash-card h-100" style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05);">
          <div class="text-warning small fw-bold text-uppercase tracking-wider mb-2">{{ __('PRIME MEMBERSHIP') }}</div>
          <h2 class="dash-card-title fs-3 mb-4">{{ __('Plan Details') }}</h2>
          
          <p class="dash-card-text text-light fw-medium mb-4">Listing On the Prime Section on respective Geo Location. Can upload upt 5 Photos to Upload.</p>
