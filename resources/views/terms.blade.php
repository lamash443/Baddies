    ...
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 col-xl-8">
        <div class="content-card">
          ...
          <p class="mt-5 small text-center" style="opacity:0.7;">If you have any questions regarding these terms, please <a href="{{ route('contact') }}">contact our support team</a>.</p>
        </div>
      </div>
    </div>
  </div>
