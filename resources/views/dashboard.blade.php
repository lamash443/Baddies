    ...
    <div class="container">
      ...
      <div class="verify-banner">
        <div class="verify-banner-content">
          <h3>{{ $dashSetting->unlock_banner_title }} <svg style="display:inline; width:20px; height:20px; color:orange; margin-left:0.2rem;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></h3>
          <p>{{ $dashSetting->unlock_banner_description }}</p>
        </div>
        <a href="{{ route('account.verify') }}" class="btn-verify">
          {{ $dashSetting->unlock_banner_button_text }}
