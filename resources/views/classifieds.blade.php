...
<x-site-preloader />
  ...
  <div class="container">
    @php $reqCat = request('category'); @endphp
    
    @if($reqCat)
      <div class="mb-3 d-lg-none">
        <a href="{{ route('classifieds') }}" class="btn btn-sm btn-outline-warning d-inline-flex align-items-center gap-2" style="border-radius: 8px;">
    ...
    <div class="class-grid">
      <!-- Personals -->
      <a href="{{ route('classifieds', ['category' => 'personals']) }}" class="class-card {{ $reqCat && $reqCat !== 'personals' ? 'd-none d-lg-flex' : '' }}">
      ...
      <!-- Massage -->
      <a href="{{ route('classifieds', ['category' => 'massage']) }}" class="class-card {{ $reqCat && $reqCat !== 'massage' ? 'd-none d-lg-flex' : '' }}">
        <div class="class-icon">
      ...
      <!-- Jobs -->
      <a href="{{ route('classifieds', ['category' => 'jobs']) }}" class="class-card {{ $reqCat && $reqCat !== 'jobs' ? 'd-none d-lg-flex' : '' }}">
        <div class="class-icon">
      ...
      <!-- Events -->
      <a href="{{ route('classifieds', ['category' => 'events']) }}" class="class-card {{ $reqCat && $reqCat !== 'events' ? 'd-none d-lg-flex' : '' }}">
        <div class="class-icon">
