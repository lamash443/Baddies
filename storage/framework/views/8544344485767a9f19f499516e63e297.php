...
<div class="auth-page-wrap">
  <div class="auth-page-card">
    ...
    <a href="<?php echo e(route('auth.google')); ?>" class="auth-google-btn mb-4">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any() && !$errors->has('email') && !$errors->has('password')): ?>
      ...
      <div class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-2">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
            <a href="<?php echo e(route('password.request')); ?>" style="color:#ff8c00; font-size:0.8rem; font-weight:600; text-decoration:none;">Forgot?</a>
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\auth\login.blade.php ENDPATH**/ ?>