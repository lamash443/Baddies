...
<?php endif; ?>
  ...
  <div class="dashboard-header">
    <div class="container">
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dashSetting->unlock_banner_enabled && is_null(Auth::user()->email_verified_at)): ?>
      <div class="verify-banner">
        <div class="verify-banner-content">
          <h3><?php echo e($dashSetting->unlock_banner_title ?? 'Verify Email'); ?> <svg style="display:inline; width:20px; height:20px; color:orange; margin-left:0.2rem;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></h3>
          <p><?php echo e($dashSetting->unlock_banner_description ?? 'Please verify your email address to unlock full account features and priority visibility.'); ?></p>
        </div>
        <a href="<?php echo e(route('account.verify')); ?>" class="btn-verify">
          <?php echo e($dashSetting->unlock_banner_button_text ?? 'Verify Now'); ?>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dashSetting->profile_banner_enabled && !$profileComplete): ?>
      <div class="verify-banner" style="margin-top: <?php echo e($showUnlockBanner ? '1rem' : '1.5rem'); ?>;">
        <div class="verify-banner-content">
          <h3><?php echo e($dashSetting->profile_banner_title); ?>
          ...
          <p><?php echo e($dashSetting->profile_banner_description); ?></p>
        </div>
        <a href="<?php echo e(route('profile.edit')); ?>" class="btn-verify">
          <?php echo e($dashSetting->profile_banner_button_text); ?>
  ...
  <div class="container pb-5 mb-5">
    <div class="row g-4 justify-content-center">
      ...
      <!-- ANNOUNCEMENT PROMOTIONAL CARD -->
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dashSetting->announcement_card_enabled): ?>
      <div class="col-12">
        <div class="promo-card">
          ...
          <div class="promo-card-title"><?php echo e($dashSetting->announcement_card_title); ?></div>
          <p class="promo-card-desc"><?php echo e($dashSetting->announcement_card_description); ?></p>
      ...
      <div class="col-12 col-md-6 col-xl-4">
        <div class="dash-card">
          ...
          <div class="dash-value" style="color: #4ade80;"><?php echo e(number_format($user->wallet_balance ?? 0, 2)); ?><span style="color: #4ade80; opacity: 0.8;">KES</span></div>
          <p class="dash-card-text">Top up your wallet to activate your profile, boost your visibility, or unlock premium features.</p>
          <a href="<?php echo e(route('wallet.add')); ?>" class="btn-ghost mt-auto">
            Add Funds
      ...
      <div class="col-12 col-md-6 col-xl-4">
        <div class="dash-card">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->hasActiveSubscription()): ?>
          <div class="status-badge" style="color: #4ade80;">
            Active
          </div>
          <h3 class="dash-card-title">Profile Status</h3>
          <p class="dash-card-text">Your profile is currently active and visible online. Plan: <strong style="color: orange;"><?php echo e(ucwords(str_replace('_', ' ', $user->subscription_plan))); ?></strong></p>
          <a href="<?php echo e(route('profile.edit')); ?>#tab-membership" class="btn-ghost mt-auto">
            Manage Plan
          ...
          <a href="<?php echo e(route('profile.edit')); ?>#tab-membership" class="btn-orange mt-auto">
            Activate Now
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
          </a>
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="col-12 col-md-6 col-xl-4">
        <div class="dash-card">
          ...
          <p class="dash-card-text">Your chat subscription is active. Plan: <strong style="color: orange;"><?php echo e(ucwords(str_replace('_', ' ', $user->chat_plan))); ?></strong></p>
          <a href="<?php echo e(route('chat.memberships')); ?>" class="btn-ghost mt-auto">
            Manage Plan
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
          </a>
          <?php else: ?>
          ...
          <a href="<?php echo e(route('chat.memberships')); ?>" class="btn-orange mt-auto">
            Activate Now
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
          </a>
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
[$__name, $__params] = $__split('dashboard-messages');
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1546477411-0', $__key);
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views/dashboard.blade.php ENDPATH**/ ?>