    ...
    <div class="row g-4">
        ...
        <div class="nr-footer__logo mb-3">
          <a href="/" class="text-decoration-none">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($siteSettings['logo'])): ?>
                <img src="<?php echo e(asset('storage/' . $siteSettings['logo'])); ?>" alt="Baddies Club Logo" style="max-height:48px;width:auto;object-fit:contain;">
            <?php else: ?>
      ...
      <div class="col-12 col-lg-4">
        ...
        <ul class="list-unstyled mb-3">
          ...
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <li class="mb-2"><a href="<?php echo e(route('contact')); ?>">Contact Support</a></li>
        </ul>
      </div>
    </div>
...
<?php if (isset($component)) { $__componentOriginala46b2bd28f407f0ee3b0bdaf82cf8c2d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala46b2bd28f407f0ee3b0bdaf82cf8c2d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.age-verification-modal','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('age-verification-modal'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginala46b2bd28f407f0ee3b0bdaf82cf8c2d)): ?>
<?php $attributes = $__attributesOriginala46b2bd28f407f0ee3b0bdaf82cf8c2d; ?>
<?php unset($__attributesOriginala46b2bd28f407f0ee3b0bdaf82cf8c2d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala46b2bd28f407f0ee3b0bdaf82cf8c2d)): ?>
<?php $component = $__componentOriginala46b2bd28f407f0ee3b0bdaf82cf8c2d; ?>
