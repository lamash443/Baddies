...
<head>
  ...
  <title>Prime Membership Checkout - Baddies Club</title>
...
<?php endif; ?>
  ...
  <div class="dashboard-header">
    <div class="container text-center">
      <h1 class="dashboard-title">Prime Membership <span>Checkout</span></h1>
      <nav aria-label="breadcrumb" class="d-flex justify-content-center mt-3">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item active text-secondary" aria-current="page"><?php echo e(__('Prime Checkout')); ?></li>
        </ol>
      </nav>
    </div>
  </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-12 col-lg-5 col-xl-4 d-none d-lg-block">
        <div class="dash-card h-100" style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05);">
          <div class="text-warning small fw-bold text-uppercase tracking-wider mb-2"><?php echo e(__('PRIME MEMBERSHIP')); ?></div>
          <h2 class="dash-card-title fs-3 mb-4"><?php echo e(__('Plan Details')); ?></h2>
          
          <p class="dash-card-text text-light fw-medium mb-4">Listing On the Prime Section on respective Geo Location. Can upload up to 5 Photos.</p>
      ...
      <div class="col-12 col-lg-7 col-xl-8" x-data="{ 
        ...
        <div class="dash-card h-100" style="border-top: 4px solid orange;">
          <form action="<?php echo e(route('membership.process')); ?>" method="POST" id="primeCheckoutForm" @submit.prevent>
            <?php echo csrf_field(); ?>



            <input type="hidden" name="plan_type" value="prime">
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\prime-checkout.blade.php ENDPATH**/ ?>