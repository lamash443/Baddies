...
<div class="auth-page-wrapper">
    ...
    <div class="auth-card">
        ...
        <form method="POST" action="<?php echo e(route('password.email')); ?>">
            ...
            <!-- Email Address -->
            <div class="mb-4">
                <label class="form-label small fw-bold mb-2" style="color:rgba(255,140,0,0.9); letter-spacing:.03em; text-transform:uppercase;"><?php echo e(__('Email Address')); ?></label>
                <input id="email" class="form-control auth-custom-input" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="Enter your email">
...
<div class="success-toast" id="pwdSuccessToast" role="alert" aria-live="assertive">
  ...
  <div class="success-toast__body">
    ...
    <p class="success-toast__msg"><?php echo e(session('status')); ?></p>
  </div>
...
<div class="err-toast" id="pwdErrToast" role="alert" aria-live="assertive">
  ...
  <div class="err-toast__body">
    ...
    <p class="err-toast__msg"><?php echo e(session('throttle_error')); ?></p>
  </div>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>