...
>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($icon || $iconAlias): ?>
        <?php echo e(\Filament\Support\generate_icon_html($icon, $iconAlias, (new FilamentComponentAttributeBag([
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($image): ?>
        <div
            ...
            <?php if($hasLoadingIndicator): ?>
                wire:loading.remove.delay.<?php echo e($loadingDelay); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasLoadingIndicator): ?>
        <?php echo e(\Filament\Support\generate_loading_indicator_html((new FilamentComponentAttributeBag([
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($badge)): ?>
        ...
        <?php else: ?>
            <span
                ...
                <?php endif; ?>
                <?php echo e((new FilamentComponentAttributeBag)->color(BadgeComponent::class, $badgeColor)->class(['fi-badge'])); ?>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\vendor\filament\support\resources\views\components\dropdown\list\item.blade.php ENDPATH**/ ?>