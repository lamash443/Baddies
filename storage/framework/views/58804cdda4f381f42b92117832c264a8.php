...
<?php endif; ?>
  ...
  <section class="hero">
    <div class="container">
      ...
      <div class="mt-4">
        <a href="<?php echo e(route('profile.edit')); ?>#tab-classifieds" class="btn btn-create-classified fw-bold px-4 py-2">
          + Create Classified
        </a>
      </div>
    </div>
      ...
      <div class="row g-4">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $classifieds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classified): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <div class="col-12 col-md-6 col-lg-4">
            <a href="<?php echo e(route('classifieds.show', $classified->id)); ?>" class="class-card" style="padding:1rem; align-items:flex-start; text-align:left; display:block; text-decoration:none;">
               ...
               <img src="<?php echo e(asset('storage/' . $classified->image_path)); ?>" alt="<?php echo e($classified->title); ?>" style="width:100%; height:200px; object-fit:cover; border-radius:12px; margin-bottom:1rem;">
               <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
               <span class="badge bg-warning text-dark mb-2 text-uppercase"><?php echo e($classified->category); ?></span>
               <h4 class="text-light fw-bold mb-1"><?php echo e($classified->title); ?></h4>
               <p class="small text-secondary mb-2"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="margin-right:4px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg><?php echo e($classified->city ?? 'N/A'); ?></p>
               <p class="text-secondary" style="font-size:0.9rem; display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical; overflow:hidden;"><?php echo e($classified->description); ?></p>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\classifieds.blade.php ENDPATH**/ ?>