<div class="table-responsive mb-3" style="padding-bottom: 0.4rem;">
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($classifieds->isEmpty()): ?>
    <div class="text-center py-4 rounded" style="border:1px dashed rgba(255,140,0,0.2);">
      ...
      <h6 class="fw-bold mb-1" style="font-size:0.9rem;"><?php echo e(__('No classifieds found.')); ?></h6>
      <p class="text-secondary mb-0" style="font-size:0.78rem;"><?php echo e(__('When you post a classified, it will appear here.')); ?></p>
    </div>
  <?php else: ?>
    <table class="table table-borderless align-middle mb-0" style="background: transparent !important; color: inherit !important;">
      ...
      <tbody>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $classifieds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <tr style="border-bottom: 1px solid rgba(255,140,0,0.08); background: transparent !important;">
            <td class="py-2 text-nowrap" style="background: transparent !important; color: inherit !important;">
              <div class="fw-bold" style="font-size:0.85rem;"><?php echo e($c->created_at->format('M d, Y')); ?></div>
            </td>
            <td class="py-2" style="background: transparent !important; color: inherit !important;">
              <div class="fw-bold" style="font-size:0.85rem;"><?php echo e($c->title); ?></div>
            </td>
            <td class="py-2 fw-bold" style="background: transparent !important; color: inherit !important; font-size:0.95rem;">
              KSh <?php echo e(number_format($c->amount, 2)); ?>

            </td>
            <td class="py-2 text-center" style="background: transparent !important;">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($c->status === 'approved'): ?>
            ...
            <td class="py-2 text-secondary" style="background: transparent !important; font-size:0.8rem;">
              <?php echo e($c->payment_status === 'paid' ? 'Wallet/M-Pesa' : 'N/A'); ?>

            </td>
            <td class="py-2 text-center" style="background: transparent !important;">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($c->payment_status === 'paid'): ?>
            ...
            <td class="py-2 text-end" style="background: transparent !important;">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($c->payment_status === 'paid'): ?>
                <a href="<?php echo e(route('classifieds.show', $c->id)); ?>" class="btn btn-sm btn-orange py-1 px-2.5" style="font-size:0.75rem;">View</a>
              <?php else: ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($classifieds->hasPages()): ?>
  <div class="d-flex justify-content-center pt-2 mt-3">
    <?php echo e($classifieds->fragment('tab-classifieds')->links('pagination::bootstrap-5')); ?>

  </div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views/profile/partials/classifieds-history.blade.php ENDPATH**/ ?>