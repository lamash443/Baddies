...
<body>
    <div class="container">
        ...
        <div class="original-message">
            <div class="original-message-title">On <?php echo e($ticket->created_at->format('M j, Y \a\t g:i A')); ?>, you wrote regarding "<?php echo e($ticket->subject); ?>":</div>
            <div style="white-space: pre-line;"><?php echo e($ticket->message); ?></div>
        </div>
        
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> Baddies Club. All rights reserved.
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\emails\support-ticket-reply.blade.php ENDPATH**/ ?>