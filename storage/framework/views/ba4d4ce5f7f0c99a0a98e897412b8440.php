...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.list.item','data' => ['badge' => $navigationItemBadge,'badgeColor' => $navigationItemBadgeColor,'href' => $navigationItemUrl,'icon' => $navigationItemIcon,'tag' => 'a','target' => $shouldNavigationItemOpenUrlInNewTab ? '_blank' : null,'ariaCurrent' => $navigationItemChild->isActive() ? 'page' : null,'attributes' => \Filament\Support\prepare_inherited_attributes($navigationItemExtraAttributes)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['badge' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($navigationItemBadge),'badge-color' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($navigationItemBadgeColor),'href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($navigationItemUrl),'icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($navigationItemIcon),'tag' => 'a','target' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($shouldNavigationItemOpenUrlInNewTab ? '_blank' : null),'aria-current' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($navigationItemChild->isActive() ? 'page' : null),'attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Filament\Support\prepare_inherited_attributes($navigationItemExtraAttributes))]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\vendor\filament\filament\resources\views\components\page\sub-navigation\mobile-menu.blade.php ENDPATH**/ ?>