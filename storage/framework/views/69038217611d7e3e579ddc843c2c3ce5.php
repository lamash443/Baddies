    ...
    <div class="container text-center">
      ...
      <nav aria-label="breadcrumb" class="d-flex justify-content-center mt-3">
        <ol class="breadcrumb mb-0 justify-content-center flex-wrap">
          ...
          <li class="breadcrumb-item"><a href="javascript:history.back()" class="text-warning text-decoration-none fw-bold"><?php echo e(__('Plan Checkout')); ?></a></li>
          <li class="breadcrumb-item active text-secondary" aria-current="page"><?php echo e(__('Checkout - MPESA')); ?></li>
        </ol>
      </nav>
    </div>
  </div>
      ...
      <div class="col-12 col-md-8 col-lg-6">
        ...
        <div class="dash-card border-top border-4" style="border-color: orange !important;">
          ...
          <div class="text-center mb-4">
            <h2 class="dash-card-title"><?php echo e(__('PAY WITH M-PESA')); ?></h2>
            <p class="text-secondary"><?php echo e(__('Enter Your M-Pesa Number Below')); ?></p>
          </div>
          ...
          <form id="mpesa-payment-form" action="#" method="POST">
            ...
            <div class="mb-4">
              <div class="input-group">
                ...
                <input id="phone-suffix" type="tel" inputmode="numeric" pattern="[0-9]*" class="form-control" placeholder="Enter mobile number" maxlength="9" required autofocus autocomplete="tel" oninput="this.value = this.value.replace(/\D/g, '')" value="<?php echo e(session('checkout_prefilled_phone', '')); ?>" style="border-left:none; border-radius:0 8px 8px 0; text-align:left; font-size:0.95rem; padding:0.65rem 0.9rem;">
              </div>
            ...
            <button type="submit" class="btn btn-mpesa">
              <?php echo e(__('Send Payment Request to Phone')); ?>
...
<?php endif; ?>
  ...
  <script>
    ...
    function resetForm() {
      ...
      submitBtn.innerHTML = '<?php echo e(__("Send Payment Request to Phone")); ?> <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"/></svg>';
    }
    ...
    document.getElementById('mpesa-payment-form').addEventListener('submit', function(e) {
      ...
      const checkoutPlanType = "<?php echo e(session('checkout_plan_type')); ?>";
      const checkoutPlan     = "<?php echo e(session('checkout_plan')); ?>";
      const classifiedId     = "<?php echo e(session('classified_id')); ?>";
      const checkoutAmount   = "<?php echo e(session('checkout_amount')); ?>";
      ...
      submitBtn.innerHTML = '<?php echo e(__("Sending Request…")); ?> <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>';
      hideAllPanels();
            ...
            if (s.status === 'completed') {
              ...
              setTimeout(() => {
                window.location.href = checkoutPlanType === 'chat'
                  ? "<?php echo e(route('chat.memberships')); ?>"
                  : "<?php echo e(route('profile.edit')); ?>#tab-publish-media";
              }, 2000);
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\mpesa-checkout.blade.php ENDPATH**/ ?>