    ...
    <div class="modal-content auth-modal-content border-0 shadow-lg" style="background:#000000; border: 1px solid rgba(255,140,0,0.5) !important; box-shadow: 0 0 40px rgba(255,140,0,0.25) !important;">
      ...
      <div class="modal-header border-0 pb-0 pt-4 px-4 px-md-5 position-relative">
        ...
        <div class="d-flex align-items-center justify-content-center w-100 gap-2 fw-bold fs-4 text-center">
          ...
          ?>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($modalLogo) && \Illuminate\Support\Facades\Storage::disk('public')->exists($modalLogo)): ?>
            <img src="<?php echo e(asset('storage/' . $modalLogo)); ?>" alt="Logo" style="max-height:64px;width:auto;object-fit:contain;">
          <?php else: ?>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade show active" id="pane-login" role="tabpanel">
            ...
            <div id="login-step-1">
              ...
              <a href="<?php echo e(route('auth.google')); ?>" class="btn auth-google-btn w-100 py-3 mb-4 d-flex align-items-center justify-content-center gap-2">
            ...
            <div id="login-step-2" class="d-none">
              ...
              <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="mb-3">
                  ...
                  <input id="login-email" type="email" name="email" class="form-control auth-custom-input" value="<?php echo e(old('email')); ?>" required autofocus placeholder="Enter your email">
                </div>
                <div class="mb-3">
                  <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                      <a href="<?php echo e(route('password.request')); ?>" class="small text-decoration-none switch-link" style="font-weight:600;">Forgot?</a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                  </div>
            ...
            <div id="register-step-2" class="d-none">
              ...
              <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="mb-3">
                  ...
                  <input id="reg-name" type="text" name="name" class="form-control auth-custom-input" value="<?php echo e(old('name')); ?>" required placeholder="Enter your name">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="small mt-1" style="color:#ff6b6b; font-weight:500;"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mb-3">
                  <label class="form-label small fw-bold mb-2" style="color:rgba(255,140,0,0.9); letter-spacing:.03em; text-transform:uppercase;">Email Address</label>
                  <input id="reg-email" type="email" name="email" class="form-control auth-custom-input" value="<?php echo e(old('email')); ?>" required placeholder="Enter a valid email">
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (authModalEl && typeof bootstrap !== 'undefined') {
      ...
      <?php if($errors->any() && !in_array(request()->route()->getName(), ['password.request', 'password.reset'])): ?>
        var modal = new bootstrap.Modal(authModalEl);
        modal.show();
        <?php if(old('name') || $errors->has('name')): ?>
          switchAuthTab('register');
          showEmailForm('register');
        <?php else: ?>
          switchAuthTab('login');
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->has('email') && !old('name')): ?>
<style>
  .auth-err-toast {
...
<div class="auth-err-toast" id="authErrToast" role="alert" aria-live="assertive">
  ...
  <div class="auth-err-toast__body">
    ...
    <p class="auth-err-toast__msg"><?php echo e($errors->first('email')); ?></p>
  </div>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views/components/auth-modal.blade.php ENDPATH**/ ?>