  ...
  <style>
    *, *::before, *::after { box-sizing:border-box; }
    ...
    .btn-orange:hover {
      ...
      box-shadow: 0 0 20px rgba(255, 140, 0, 0.55), 0 4px 14px rgba(0,0,0,0.3) !important;
    ...
    <form method="GET" action="<?php echo e(route('location.show', $searchLocation)); ?>" id="locationFilterForm">
      <div class="cb-filters-wrapper">
        <div class="cb-filter-header">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($gender) || !empty($orientation) || (!empty($sort) && $sort !== 'featured')): ?>
            <a href="<?php echo e(route('location.show', $searchLocation)); ?>" class="cb-filter-reset">
        ...
        <div class="cb-filter-controls">
          <div class="cb-filter-item">
            <select name="gender" class="cb-filter-select <?php echo e(!empty($gender) ? 'is-active' : ''); ?>" aria-label="Select Gender" onchange="document.getElementById('locationFilterForm').submit()">
          ...
          <div class="cb-filter-item">
            <select name="orientation" class="cb-filter-select <?php echo e(!empty($orientation) ? 'is-active' : ''); ?>" aria-label="Select Sexual Orientation" onchange="document.getElementById('locationFilterForm').submit()">
          ...
          <div class="cb-filter-item cb-filter-sort">
            <select name="sort" class="cb-filter-select <?php echo e((!empty($sort) && $sort !== 'featured') ? 'is-active' : ''); ?>" aria-label="Sort by" onchange="document.getElementById('locationFilterForm').submit()">
  ...
  <?php else: ?>
    <div class="text-center py-5">
      <div style="max-width: 540px; margin: 0 auto; background: linear-gradient(145deg, rgba(26,15,0,0.8), rgba(13,13,13,0.9)); border: 1px solid rgba(255, 140, 0, 0.25); border-radius: 20px; padding: 3.5rem 2rem; box-shadow: 0 15px 40px rgba(0,0,0,0.6), inset 0 0 0 1px rgba(255,255,255,0.05);">
        ...
        <a href="#" class="btn-orange text-decoration-none" data-bs-toggle="modal" data-bs-target="#authModal" data-auth-tab="register">
