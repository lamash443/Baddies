...
<head>
  ...
  <title>Regular Membership Checkout - Baddies Club</title>
...
<?php endif; ?>
  ...
  <div class="dashboard-header">
    <div class="container text-center">
      <h1 class="dashboard-title">Regular Membership <span>Checkout</span></h1>
      <nav aria-label="breadcrumb" class="d-flex justify-content-center mt-3">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item"><a href="<?php echo e(route('profile.edit')); ?>#tab-membership" class="text-warning text-decoration-none fw-bold"><?php echo e(__('My Membership')); ?></a></li>
          <li class="breadcrumb-item active text-secondary" aria-current="page"><?php echo e(__('Regular Checkout')); ?></li>
        </ol>
      </nav>
    </div>
  </div>
        ...
        <div class="dash-card mb-0 py-3 px-4">
          <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center gap-3">
              ...
              <div>
                <div class="text-secondary small text-uppercase fw-bold" style="letter-spacing:1px;"><?php echo e(__('Available Balance')); ?></div>
                <div class="fs-4 fw-bold text-light mt-1">KSh <?php echo e(number_format(auth()->user()->wallet_balance ?? 0, 2)); ?></div>
              </div>
            </div>
            <a href="<?php echo e(route('wallet.add')); ?>" class="btn btn-orange btn-sm px-3 py-2" style="font-size: 0.9rem;"><?php echo e(__('Add Funds')); ?></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-12 col-lg-5 col-xl-4 d-none d-lg-block">
        <div class="dash-card h-100" style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05);">
          <div class="text-warning small fw-bold text-uppercase tracking-wider mb-2"><?php echo e(__('REGULAR MEMBERSHIP')); ?></div>
          <h2 class="dash-card-title fs-3 mb-4"><?php echo e(__('Plan Details')); ?></h2>
          
          <p class="dash-card-text text-light fw-medium mb-4">Listing On the Bottom Section of the website on respective Geo Location. Can upload up to 4 Photos.</p>
          ...
          <ul class="list-unstyled plan-list mb-0">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $plan?->pricing ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $days => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
              <li class="d-flex align-items-center gap-2">
                ...
                <?php echo e($days); ?> <?php echo e((int)$days === 1 ? 'Day' : 'Days'); ?> Listing = <span><?php echo e(number_format($price)); ?> Ksh</span>
              </li>
      ...
      <div class="col-12 col-lg-7 col-xl-8" x-data="{ 
        step: 1, 
        planPrice: <?php echo e($plan?->pricing ? max(array_values($plan->pricing)) : 2000); ?>, 
        planDays: <?php echo e($plan?->pricing ? array_key_last($plan->pricing) : 30); ?>,
        paymentMethod: 'mpesa',
        mpesaPhone: '', 
        loading: false
      }">
        <div class="dash-card h-100" style="border-top: 4px solid orange;">
          <form action="<?php echo e(route('membership.process')); ?>" method="POST" id="regularCheckoutForm" @submit.prevent>
            <?php echo csrf_field(); ?>
            ...
            <div x-show="step === 1" x-transition>
              <div class="row g-4 mb-4">
                <div class="col-12 col-md-6">
                  ...
                  ?>
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pricing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $days => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
              ...
              <div class="mt-2" x-show="paymentMethod === 'mpesa'">
                <span class="fee-note">
                  ...
                  <?php echo e(__('Transaction Fee:')); ?> <strong>0% + 0</strong> &mdash; <?php echo e(__('No hidden charges on MPESA.')); ?>
              ...
              <div class="p-3 rounded my-3 d-lg-none" style="background:rgba(255,140,0,0.04); border:1px solid rgba(255,140,0,0.2); border-radius:12px;">
                <div class="text-warning small fw-bold text-uppercase tracking-wider mb-2" style="font-size:0.78rem;"><?php echo e(strtoupper($plan?->name ?? 'Membership')); ?> <?php echo e(__('Plan Details & Limits')); ?></div>
                <ul class="list-unstyled mb-0" style="font-size:0.85rem; line-height:1.7;">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $plan?->pricing ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $days => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <li class="d-flex align-items-center gap-2 text-secondary">
                      ...
                      <span class="text-light fw-medium"><?php echo e($days); ?> <?php echo e((int)$days === 1 ? 'Day' : 'Days'); ?> Listing</span> = <span class="text-warning"><?php echo e(number_format($price)); ?> Ksh</span>
                    </li>
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $plan?->features ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <li class="d-flex align-items-center gap-2 text-secondary">
  ...
  <script>
    ...
    (function() {
      ...
      submitBtn.addEventListener('click', function() {
        ...
        fetch("<?php echo e(route('payment.initiate')); ?>", {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>" },
          body: JSON.stringify({ phone, purpose: 'membership', plan_type: 'regular', plan_days: planDays })
        })
        .then(r => r.json())
        .then(data => {
          if (!data.success) {
          ...
          window._rcPoll = setInterval(() => {
            ...
            if (pollCount > maxPolls) {
              ...
              rcShowPanel('timeout');
              submitBtn.disabled = false;
              setTimeout(() => window.location.href = "<?php echo e(route('profile.edit')); ?>#tab-wallet", 2500);
              return;
            }
            ...
            .then(s => {
              if (s.status === 'completed') {
                clearInterval(window._rcPoll);
                rcShowPanel('success');
                setTimeout(() => window.location.href = "<?php echo e(route('profile.edit')); ?>#tab-publish-media", 2000);
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\regular-checkout.blade.php ENDPATH**/ ?>