    ...
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 col-xl-8">
        <div class="content-card">
          ...
          <p class="mt-5 small text-center" style="opacity:0.7;">If you have any questions about our privacy practices, please <a href="<?php echo e(route('contact')); ?>">contact our support team</a>.</p>
        </div>
      </div>
    </div>
  </div>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views/privacy.blade.php ENDPATH**/ ?>