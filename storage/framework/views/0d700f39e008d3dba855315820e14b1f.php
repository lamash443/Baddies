...
<button
    <?php if($isSidebarCollapsibleOnDesktop): ?>
        x-bind:aria-label="$store.sidebar.isOpen ? null : <?php echo \Illuminate\Support\Js::from($databaseNotificationsLabel)->toHtml() ?>"
    <?php endif; ?>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\vendor\filament\filament\resources\views\components\sidebar\database-notifications-trigger.blade.php ENDPATH**/ ?>