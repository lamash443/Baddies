<div wire:poll.3s>
    <div class="d-flex align-items-center justify-content-between mb-4 position-relative">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->hasActiveChatSubscription()): ?>
            <a href="<?php echo e(route('chat.index')); ?>" wire:navigate class="btn-ghost" style="width:auto; padding:0.5rem 1.1rem; font-size:0.82rem;">
                Open Inbox
                   ...
                   style="border:1px solid rgba(255,140,0,0.15); border-radius:12px; padding:0.85rem 1rem; transition:all 0.2s ease;">
                    <div class="position-relative flex-shrink-0">
                        <img src="<?php echo e($cover); ?>" alt="<?php echo e($displayName); ?>"
                             style="width:46px; height:46px; border-radius:50%; object-fit:<?php echo e($isAdmin ? 'contain' : 'cover'); ?>; border:2px solid rgba(255,140,0,0.3); background:#111;">
