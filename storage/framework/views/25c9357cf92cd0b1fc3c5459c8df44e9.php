  ...
  <div class="auth-page-card">
    ...
    <div class="auth-header">
      ...
      <a href="<?php echo e(url('/')); ?>" style="text-decoration:none;">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($siteLogo)): ?>
          <img src="<?php echo e(asset('storage/' . $siteLogo)); ?>" alt="Kenyan Baddies Club" style="max-height:64px;width:auto;">
        <?php else: ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($referrer): ?>
      <div class="referral-badge">
        ...
        <span>You were invited by <strong style="color:#fff;"><?php echo e($referrer->name); ?></strong> — sign up &amp; top up to unlock your welcome bonus!</span>
      </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any() && !$errors->has('name') && !$errors->has('email') && !$errors->has('password')): ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" novalidate>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($refCode): ?>
        <input type="hidden" name="ref" value="<?php echo e($refCode); ?>">
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\auth\register.blade.php ENDPATH**/ ?>