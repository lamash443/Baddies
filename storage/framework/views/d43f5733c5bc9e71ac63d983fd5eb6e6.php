<section class="dash-card" style="border-color: rgba(220,53,69,0.2);">
    <header>
        ...
        <p class="dash-card-text" style="font-size:0.8rem;"><?php echo e(__('Once your account is deleted, all of its resources and data will be permanently deleted. This action cannot be undone.')); ?></p>
    </header>
            ...
            <form method="post" action="<?php echo e(route('profile.destroy')); ?>">
                ...
                <div class="del-modal__header">
                    ...
                    <div class="del-modal__heading-wrap">
                        <h5 class="del-modal__title" id="confirmUserDeletionModalLabel"><?php echo e(__('Delete Account')); ?></h5>
                        <p class="del-modal__sub"><?php echo e(__('This action requires admin approval')); ?></p>
                    </div>
                ...
                <div class="del-modal__body">
                    ...
                    <div class="del-modal__field">
                        <label for="del_password" class="del-modal__label">
                            ...
                            <?php echo e(__('Confirm Your Password')); ?>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>