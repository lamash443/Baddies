...
<?php endif; ?>
  ...
  <script>
    if (window.location.hash === '#vip-escorts') {
      window.location.replace("<?php echo e(route('escort-girls')); ?>");
    }
  </script>
...
<section class="home-hero">
  <div class="home-hero__bg">
    <img src="<?php echo e(!empty($siteSettings['hero_background']) ? asset('storage/' . $siteSettings['hero_background']) : asset('images/header-image.jpg')); ?>" alt="" aria-hidden="true" class="home-hero__bg-img"
  ...
  <div class="home-hero__inner">
    ...
    <h1 class="home-hero__title">
      <?php echo $siteSettings['hero_title'] ?? 'Meet Beautiful <span>Kenyan Baddies</span><br>Near You Tonight'; ?>

    </h1>
    <p class="home-hero__sub">
      <?php echo e($siteSettings['hero_subtitle'] ?? 'Browse verified VIP escorts, call girls, and adult classifieds across Nairobi and all of Kenya. Discreet, safe, and always online.'); ?>

    </p>
    <div class="home-hero__cta-group">
      <a href="<?php echo e(route('escort-girls')); ?>" class="btn-orange">Browse VIP Escorts</a>
      ...
      <a href="<?php echo e(route('profile.edit')); ?>" class="btn-outline-orange">My Profile</a>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="cat-marquee-wrapper">
      <div class="cat-marquee-track">
        ...
        <a href="<?php echo e(route('escort-girls')); ?>" class="cat-card">
        ...
        <a href="<?php echo e(route('chat.memberships')); ?>" class="cat-card">
          <div class="cat-card__icon">
        ...
        <a href="<?php echo e(route('escort-girls')); ?>" class="cat-card" aria-hidden="true">
          <div class="cat-card__icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
          </div>
          <div class="cat-card__info">
        ...
        <a href="<?php echo e(route('chat.memberships')); ?>" class="cat-card" aria-hidden="true">
          <div class="cat-card__icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>
          </div>
          <div class="cat-card__info">
...
<section id="vip-escorts" class="home-section" style="padding-top:0;">
  <div class="container">
    ...
    <div class="home-listing-grid">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $vipGirls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
<section id="prime-vip-escorts" class="home-section" style="padding-top:0;">
  <div class="container">
    ...
    <div class="home-listing-grid">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $primeVipGirls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <?php echo $__env->make('partials.user-card', ['user' => $user], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        <div class="col-12 text-center py-4 empty-listing-notice" style="font-size:.9rem;">
...
<section id="prime-escorts" class="home-section" style="padding-top:0;">
  <div class="container">
    ...
    <div class="home-listing-grid">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $primeGirls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <?php echo $__env->make('partials.user-card', ['user' => $user], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        <div class="col-12 text-center py-4 empty-listing-notice" style="font-size:.9rem;">
  ...
  <div class="container">
    <div class="home-section-header">
      <div>
        ...
        <p class="home-section-sub"><?php echo e(\App\Models\SiteSetting::get('call_girls_subtitle', 'Verified escorts and call girls across Kenya')); ?></p>
        <div class="home-section-line"></div>
      </div>
    </div>
    <div class="home-listing-grid">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $regularGirls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <?php echo $__env->make('partials.user-card', ['user' => $user], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        <div class="col-12 text-center py-4 empty-listing-notice" style="font-size:.9rem;">
  ...
  <div class="container">
    <div class="home-section-header">
      <div>
        ...
        <p class="home-section-sub"><?php echo e(\App\Models\SiteSetting::get('classifieds_subtitle', 'Personals, jobs, and adult services')); ?></p>
        <div class="home-section-line"></div>
      </div>
  ...
  <div class="container">
    <div class="home-section-header">
      <div>
        ...
        <p class="home-section-sub"><?php echo e(\App\Models\SiteSetting::get('hiw_subtitle', 'Find your perfect match in 3 simple steps')); ?></p>
        <div class="home-section-line"></div>
      </div>
    </div>
    <div class="hiw-grid">
      <div class="hiw-card">
        ...
        <div class="hiw-card__title"><?php echo e(\App\Models\SiteSetting::get('hiw_step1_title', 'Browse Profiles')); ?></div>
        <div class="hiw-card__body"><?php echo e(\App\Models\SiteSetting::get('hiw_step1_body', 'Browse hundreds of verified escorts and call girls near you. Filter by location, price, or category.')); ?></div>
      </div>
      <div class="hiw-card">
        ...
        <div class="hiw-card__title"><?php echo e(\App\Models\SiteSetting::get('hiw_step2_title', 'View Profile')); ?></div>
        <div class="hiw-card__body"><?php echo e(\App\Models\SiteSetting::get('hiw_step2_body', 'See full details — photos, rates, services, and location. Everything you need to make the right choice.')); ?></div>
      </div>
      <div class="hiw-card">
        ...
        <div class="hiw-card__title"><?php echo e(\App\Models\SiteSetting::get('hiw_step3_title', 'Connect Directly')); ?></div>
        <div class="hiw-card__body"><?php echo e(\App\Models\SiteSetting::get('hiw_step3_body', 'Reach out directly via the profile contact details. No middlemen, no delays — just direct connection.')); ?></div>
      </div>
      <div class="hiw-card">
        ...
        <div class="hiw-card__title"><?php echo e(\App\Models\SiteSetting::get('hiw_step4_title', 'Enjoy VIP Perks')); ?></div>
        <div class="hiw-card__body"><?php echo e(\App\Models\SiteSetting::get('hiw_step4_body', 'Upgrade to VIP to unlock priority visibility, more photos, videos, and exclusive features.')); ?></div>
      </div>
    </div>
  </div>
</section>
...
<section class="home-section" style="padding-top:0;">
  <div class="container">
    <div class="baddies-editorial">
      ...
      <h2 class="ed-heading"><?php echo $edHeading; ?></h2>

      <p class="ed-body"><?php echo e($edIntro); ?></p>

      <div class="ed-divider"></div>

      <h3 class="ed-subheading"><?php echo e($edLocalTitle); ?></h3>
      <?php echo renderEditorialBody($edLocalBody); ?>


      <div class="ed-divider"></div>

      <h3 class="ed-subheading"><?php echo e($edServicesTitle); ?></h3>
      <?php echo renderEditorialBody($edServicesBody); ?>


      <div class="ed-divider"></div>

      <h3 class="ed-subheading"><?php echo e($edMeetTitle); ?></h3>
      <?php echo renderEditorialBody($edMeetBody); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('deletion_pending')): ?>
<style>
  .del-toast {
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views/welcome.blade.php ENDPATH**/ ?>