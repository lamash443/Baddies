    ...
    <div class="container text-center">
      ...
      <nav aria-label="breadcrumb" class="d-flex justify-content-center mt-3">
        <ol class="breadcrumb mb-0 justify-content-center flex-wrap text-center">
          <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>" class="text-warning text-decoration-none fw-bold"><?php echo e(__('Home')); ?></a></li>
          ...
          <li class="breadcrumb-item active text-secondary" aria-current="page"><?php echo e(__('Add Fund/Checkout - MPESA')); ?></li>
        </ol>
      </nav>
    </div>
  </div>
    ...
    <div class="row g-4 align-items-start">
      ...
      <div class="col-12 col-lg-3 mb-4 mb-lg-0">
        <div class="side-nav-card">
          ...
          <a href="<?php echo e(route('profile.edit')); ?>" class="side-nav-link">
          ...
          <a href="<?php echo e(route('wallet.add')); ?>" class="side-nav-link active">
          ...
          <a href="<?php echo e(route('profile.edit')); ?>#tab-membership" class="side-nav-link">
          ...
          <a href="<?php echo e(url('/classifieds')); ?>" class="side-nav-link">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
            My Classifieds
          </a>

          <a href="<?php echo e(route('profile.edit')); ?>#tab-photos" class="side-nav-link">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
            Publish Photos &amp; Videos
          </a>

          <a href="<?php echo e(route('profile.edit')); ?>#tab-settings" class="side-nav-link">
          ...
          <a href="<?php echo e(route('profile.edit')); ?>#tab-verification" class="side-nav-link">
          ...
          <a href="<?php echo e(route('profile.edit')); ?>#tab-referrals" class="side-nav-link">
      ...
      <div class="col-12 col-lg-9" id="main-content-area">
        ...
        <div class="dash-card mb-4">
          <header class="mb-3">
            ...
            <p class="dash-card-text mb-0" style="font-size: 0.82rem;"><?php echo e(__('Your current funds available for memberships and features. Available for premium features & upgrades.')); ?></p>
          </header>
        ...
        <div class="dash-card" style="border-top: 4px solid orange;">
          ...
          <header class="mb-4 text-center">
            <h2 class="dash-card-title"><?php echo e(__('Add Funds to your Wallet')); ?></h2>
            <p class="dash-card-text mb-0"><?php echo e(__('Enter the amount you wish to add. Funds are credited instantly upon payment.')); ?></p>
          </header>

          <form action="<?php echo e(url('/wallet/add-funds')); ?>" method="POST" id="add-funds-form">
            <?php echo csrf_field(); ?>

            <div class="mb-4">
              <label class="form-label"><?php echo e(__('Amount')); ?> <span class="text-secondary fw-normal" style="font-size:0.85rem;">(<?php echo e(__('Minimum: KSh 10')); ?>)</span></label>
              ...
              <div id="amount-error" class="mt-2 text-danger small" style="display:none;">
                ...
                <?php echo e(__('Minimum deposit amount is KSh 10.')); ?>
            ...
            <div class="p-4 rounded mb-4" style="background:rgba(255,255,255,0.03); border:1px solid rgba(255,255,255,0.1);">
              <div class="summary-row">
                <span class="summary-label"><?php echo e(__('Transaction Fee:')); ?></span>
                <span class="summary-value" id="fee-display">KSh 0.00</span>
              </div>
              <div class="summary-row">
                <span class="summary-total-label"><?php echo e(__('Total:')); ?></span>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\wallet-add-funds.blade.php ENDPATH**/ ?>