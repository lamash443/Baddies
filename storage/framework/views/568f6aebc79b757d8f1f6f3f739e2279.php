<style>
  ...
  .sidebar-icon-link:hover, .sidebar-icon-link:active {
      ...
      <div class="d-flex flex-column gap-4 px-2 pb-4">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-icon-link d-flex align-items-center gap-3 text-decoration-none">
        ...
        <div class="nr-navbar__inner mt-3 mt-xl-0 d-xl-flex w-100 align-items-center">
          <div class="nr-navbar__center flex-grow-1 d-xl-flex justify-content-xl-center">
            ...
            <ul class="navbar-nav nr-navbar__menu gap-xl-2 text-center text-xl-start">
                                                                <li class="nav-item">
                    <a class="nav-link custom-orange-link <?php echo e(request()->is('/') ? 'active' : ''); ?>" href="/#vip-escorts">Escort Girls</a>
                  </li>
                                                                                <li class="nav-item">
                    ...
                    <a class="nav-link custom-orange-link <?php echo e(request()->is('videos') ? 'active' : ''); ?>" href="/videos">Videos</a>
                                                                                ...
                                                                                <li class="nav-item">
                    <a class="nav-link custom-orange-link <?php echo e(request()->is('hot-hookups') ? 'active' : ''); ?>" href="/hot-hookups">Hot Hookups</a>
                  </li>
                  ...
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                  <li class="nav-item">
                    <a class="nav-link custom-orange-link <?php echo e(request()->is('dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
            ...
            <div class="d-flex flex-column flex-xl-row justify-content-xl-end align-items-xl-center gap-2">
              ...
              <button id="themeToggleBtn" class="btn p-0 me-3 d-none d-xl-flex align-items-center justify-content-center" type="button" style="width: 36px; height: 36px; background-color: transparent; flex-shrink: 0;" title="Toggle Theme">
                ...
                <button class="btn p-0" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="width: 42px; height: 42px; border-radius: 50%; border: 2px solid orange; background-color: <?php echo e(Auth::check() ? 'orange' : 'transparent'); ?>; display: flex; align-items: center; justify-content: center; flex-shrink: 0; overflow: hidden; padding: 0;">
                  ...
                  <?php else: ?>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="<?php echo e(Auth::check() ? 'black' : 'orange'); ?>" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                      <circle cx="12" cy="7" r="4"></circle>
                    </svg>
                  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\components\navbar_original_exact.blade.php ENDPATH**/ ?>