...
<article class="nr-listing-card fi<?php echo e($animIndex); ?>" style="cursor:pointer;" onclick="window.location.href='<?php echo e(url('profile', $user->id)); ?>'" role="button" tabindex="0" aria-label="View <?php echo e($name); ?> profile" onkeydown="if(event.key==='Enter')window.location.href='<?php echo e(url('profile', $user->id)); ?>'">
  <div class="nr-listing-card__media-shell">
    <div class="nr-listing-card__media-wrap">
      <img class="nr-listing-card__media" src="<?php echo e($cover); ?>" alt="<?php echo e($name); ?>" loading="lazy">

      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($planType === 'prime_vip'): ?>
        <span class="nr-plan-badge nr-plan-badge--prime-vip">Prime VIP</span>
      <?php elseif($planType === 'prime'): ?>
        <span class="nr-plan-badge nr-plan-badge--prime">Prime</span>
      <?php elseif($planType === 'vip'): ?>
  ...
  <div class="nr-listing-card__body">
    <div class="nr-listing-card__eyebrow"><?php echo e($cardLabel); ?></div>

    <h3 class="nr-listing-card__title">
      <a href="<?php echo e(url('profile', $user->id)); ?>"><?php echo e($name); ?></a>
    </h3>
    ...
    <div class="nr-listing-card__values">
      ...
      <div class="nr-listing-card__value">
        ...
        <span class="nr-listing-card__value-text"><?php echo e($age); ?></span>
      </div>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="nr-listing-card__value">
        ...
        <span class="nr-listing-card__value-text"><?php echo e($city); ?></span>
      </div>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>

    <div class="mt-auto pt-2 d-flex gap-2">
      <a class="btn btn-primary flex-grow-1" href="<?php echo e(url('profile', $user->id)); ?>" onclick="event.stopPropagation();">View Profile</a>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasActiveChatSubscription()): ?>
          <a class="btn flex-grow-1 d-flex align-items-center justify-content-center gap-1 btn-chat-card" href="<?php echo e(route('chat.show', $user->id)); ?>" onclick="event.stopPropagation();">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
            Chat
          </a>
        <?php else: ?>
          <a class="btn flex-grow-1 d-flex align-items-center justify-content-center gap-1 btn-chat-card" href="<?php echo e(route('chat.memberships')); ?>" onclick="event.stopPropagation();">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
            Chat
          </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\partials\user-card.blade.php ENDPATH**/ ?>