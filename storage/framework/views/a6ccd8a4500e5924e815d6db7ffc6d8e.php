  ...
  <div class="age-modal-card">
    ...
    <div id="ageModalMainContent">
      ...
      <div class="age-brand-header">
        ...
        ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($ageModalLogo) && \Illuminate\Support\Facades\Storage::disk('public')->exists($ageModalLogo)): ?>
          <img src="<?php echo e(asset('storage/' . $ageModalLogo)); ?>" alt="Logo" style="max-height:32px;width:auto;object-fit:contain;">
        <?php else: ?>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\components\age-verification-modal.blade.php ENDPATH**/ ?>