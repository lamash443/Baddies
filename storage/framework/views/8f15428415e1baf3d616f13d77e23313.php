...
<?php endif; ?>
  ...
  <title>Terms of Service - Baddies Club</title>
...
<?php endif; ?>
  ...
  <div class="page-header text-center">
    <div class="container">
      ...
      <p class="page-sub">Please read these terms carefully before using our platform. Last updated: August 2026.</p>
    </div>
  </div>
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 col-xl-8">
        <div class="content-card">
          <?php echo $sitePage?->content; ?>

          
          <p class="mt-5 small text-center" style="opacity:0.7;">If you have any questions regarding these terms, please <a href="<?php echo e(route('contact')); ?>">contact our support team</a>.</p>
        </div>
      </div>
    </div>
  </div>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\terms.blade.php ENDPATH**/ ?>