    ...
    <div class="container text-center">
      ...
      <nav aria-label="breadcrumb" class="d-flex justify-content-center mt-3">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item active text-secondary" aria-current="page"><?php echo e(__('Prime VIP Checkout')); ?></li>
        </ol>
      </nav>
    </div>
  </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-12 col-lg-5 col-xl-4 d-none d-lg-block">
        <div class="dash-card h-100" style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05);">
          <div class="text-warning small fw-bold text-uppercase tracking-wider mb-2"><?php echo e(__('PRIME VIP MEMBERSHIP')); ?></div>
      ...
      <div class="col-12 col-lg-7 col-xl-8" x-data="{ 
        ...
        <div class="dash-card h-100" style="border-top: 4px solid orange;">
          <form action="<?php echo e(route('membership.process')); ?>" method="POST" id="primeVipCheckoutForm" @submit.prevent>
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\prime-vip-checkout.blade.php ENDPATH**/ ?>