...
<div class="auth-page-wrapper">
  ...
  <div class="auth-card">
    <!-- Back arrow -->
    <a href="<?php echo e(route('password.request')); ?>" class="auth-back-arrow" title="Back">
    ...
    <form method="POST" action="<?php echo e(route('password.store')); ?>" id="resetPwForm">
      <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
          <div class="small mt-1" style="color:#ff6b6b; font-weight:500;"><?php echo e($message); ?></div>
        <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <p class="text-center mt-3 mb-0" style="font-size:0.85rem; color:rgba(255,255,255,0.4);">
        Remembered it?
        <a href="<?php echo e(route('login')); ?>" style="color:#ff8c00; text-decoration:none; font-weight:600;">Sign In</a>
      </p>
    </form>
  </div>
</div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any() && !$errors->has('email') && !$errors->has('password') && !$errors->has('password_confirmation')): ?>
<style>
...
<div class="err-toast" id="genErrToast">
  ...
  <div class="err-toast__body">
    ...
    <p class="err-toast__msg"><?php echo e($errors->first()); ?></p>
  </div>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>