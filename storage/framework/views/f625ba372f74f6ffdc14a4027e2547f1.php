...
<style>
    *, *::before, *::after { box-sizing:border-box; }
    ...
    /* PAGE HEADER */
    .cb-page-header { position:relative; overflow:hidden; padding:4.5rem 0 3.5rem; background:linear-gradient(180deg,rgba(0,0,0,0.72) 0%,rgba(13,13,13,0.92) 100%), url('<?php echo e($escortGirlsBg); ?>') center/cover no-repeat; border-bottom:1px solid rgba(255,140,0,0.25); margin-bottom:0; }
    ...
    [data-bs-theme="light"] .cb-page-header { background: linear-gradient(180deg, rgba(255,255,255,0.85) 0%, rgba(244,246,249,0.95) 100%), url('<?php echo e($escortGirlsBg); ?>') center/cover no-repeat !important; border-bottom-color: rgba(0,0,0,0.1) !important; }
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views/escort-girls.blade.php ENDPATH**/ ?>