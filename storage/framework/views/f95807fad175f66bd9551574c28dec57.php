...
<?php endif; ?>
  ...
  <div class="page-header">
    <div class="container text-center">
      ...
      <p class="page-sub"><?php echo e(__('Unlock unlimited conversations. Choose the plan that fits you.')); ?></p>
    </div>
  </div>
  ...
  <div class="container pb-5 mb-5">
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="info-card">
          <div class="d-flex align-items-center gap-3 mb-3">
            ...
            <div>
              ...
              <div class="info-card-value">KSh <?php echo e(Auth::check() ? number_format(Auth::user()->wallet_balance ?? 0, 2) : '0.00'); ?></div>
            </div>
          </div>
          <p class="text-secondary small mb-3">Use your wallet balance to subscribe instantly — no MPESA needed.</p>
          <a href="<?php echo e(route('wallet.add')); ?>" class="btn btn-plan w-100">
      ...
      <!-- Active Chat Plan -->
      <div class="col-12 col-md-6">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::check() && Auth::user()->hasActiveChatSubscription()): ?>
          <div class="active-plan-card">
            <div class="d-flex align-items-center gap-3 mb-3">
              ...
              <div>
                ...
                <div class="info-card-value" style="color:#28a745;"><?php echo e(ucwords(str_replace('_',' ', Auth::user()->chat_plan))); ?></div>
              </div>
            </div>
            <div class="d-flex align-items-center gap-2 text-secondary small">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
              Expires: <span class="text-warning fw-bold ms-1"><?php echo e(Auth::user()->chat_expires_at ? Auth::user()->chat_expires_at->format('d M Y, h:i A') : 'Never'); ?></span>
            </div>
          </div>
        <?php else: ?>
    ...
    <div class="row g-3">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $chatPricing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $days => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <?php $isFeatured = (int)$days === $featuredDays; ?>
        <div class="col-12 col-sm-6 col-lg d-flex">
          <div class="plan-card <?php echo e($isFeatured ? 'featured' : ''); ?> w-100">
            <div class="plan-days"><?php echo e($days); ?> <?php echo e((int)$days === 1 ? 'Day' : 'Days'); ?></div>
            <div class="plan-price"><sup>KSh</sup><?php echo e(number_format($price)); ?></div>
            <div class="plan-per">for <?php echo e($days); ?> <?php echo e((int)$days === 1 ? 'day' : 'days'); ?> · <?php echo e((int)$days === $maxDays ? 'best value' : 'billed once'); ?></div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $chatFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($labels[$days])): ?>
              <div class="plan-feature">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"><polyline points="20 6 9 17 4 12"/></svg>
                <?php echo e($labels[$days]); ?>

              </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <a href="<?php echo e(route('chat.checkout')); ?>" class="btn-plan mt-3">Get Started</a>
          </div>
        </div>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    </div>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views/chat-memberships.blade.php ENDPATH**/ ?>