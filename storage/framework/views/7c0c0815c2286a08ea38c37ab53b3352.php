...
<?php endif; ?>
  ...
  <div class="dashboard-header">
    <div class="container text-center">
      ...
      <p class="dashboard-sub"><?php echo e(__('Follow the steps below to verify your account and unlock premium access.')); ?></p>
    </div>
  </div>
      ...
      <div class="col-12 col-lg-8 col-xl-7">
        ...
        <div class="dash-card mb-4" style="border-top: 4px solid orange;">
          ...
          <div class="mb-4 text-center">
            ...
            <h3 class="text-white mb-3 fw-bold"><?php echo e(__('Verify Your Email Address')); ?></h3>
            <p class="text-secondary mx-auto" style="font-size: 1.05rem; max-width: 500px; line-height: 1.6;">
              <?php echo e(__('Thanks for signing up! Before getting started, you must verify your email address. Please click on the link we just emailed to you. If you didn\'t receive the email, we will gladly send you another.')); ?>
          ...
          <form method="POST" action="<?php echo e(route('logout')); ?>" class="mt-4 text-center">
            <?php echo csrf_field(); ?>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        toast.innerHTML = `
            ...
            <?php echo e(\App\Models\Setting::getSettings()->verification_toast_message ?? __('A new verification link has been sent to your email address.')); ?>
...
<?php /**PATH C:\Users\willi\Desktop\Kenyan Baddies Club\resources\views\verify-account.blade.php ENDPATH**/ ?>